...
public interface IWheelPicker {
     ...
     * {@link com.itheima.wheelpicker.OnItemSelectedListener}回调监听或调用
     ...
     * through {@link com.itheima.wheelpicker.OnItemSelectedListener} or call
     ...
     * 前所根据这些参数改变的一些属性，比如
     * {@link com.itheima.wheelpicker.OnWheelChangeListener}和
     * {@link com.itheima.wheelpicker.OnItemSelectedListener}监听器中方法参数的值，因
     * 此你总该在调用该方法后考虑到相关影响
     ...
     * {@link com.itheima.wheelpicker.OnWheelChangeListener} and
     * {@link com.itheima.wheelpicker.OnItemSelectedListener}, so you must always
     ...
     * @see com.itheima.wheelpicker.OnWheelChangeListener
     */
