...
public class ExampleUnitTest {
    ...
    @Before
    public void before() {
        System.out.println("-------------------开始测试-------------------, = " + (32777.83-1000-951.8-925.9-987.9-976.5-963.7-984-1000-945.6-981.2-976-1000-965.2-987.4-943-952.9-1000-985.5-915.1-931.5-975.6-961.9-980.3-979.1-952.2-1000-945.7-985.5-974.8-938.4-971.6-956.3-943.8));
        mGson = new Gson();
    }
