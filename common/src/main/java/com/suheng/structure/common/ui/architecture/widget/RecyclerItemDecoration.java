package com.suheng.structure.common.ui.architecture.widget;
...
public class RecyclerItemDecoration extends RecyclerView.ItemDecoration {
    private static final String TAG = RecyclerItemDecoration.class.getSimpleName();
    ...
    public RecyclerItemDecoration(Context context) {
        ...
        mListDivider = context.getResources().getDrawable(android.R.drawable.divider_horizontal_bright);
    }
