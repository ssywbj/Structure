...
/**
 * MyScrollView is just like {@link android.widget.ScrollView}, but it supports acting
...
public class MyScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final MyScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            MyScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            int childSize = child.getHeight() + lp.topMargin + lp.bottomMargin;
            int parentSpace = getHeight() - getPaddingTop() - getPaddingBottom();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                MyScrollView.LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final MyScrollView nsvHost = (MyScrollView) host;
