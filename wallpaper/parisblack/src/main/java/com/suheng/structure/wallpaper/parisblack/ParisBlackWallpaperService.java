...
public class ParisBlackWallpaperService extends WallpaperService {
    ...
    private final class LiveWallpaperEngine extends Engine {
        ...
        private void onDraw(Canvas canvas) {
            ...
            if (mAmbientMode) {
                canvas.drawColor(Color.GRAY);//画面背景
                ...
                canvas.drawColor(Color.RED);//画面背景
        ...
        private void registerBatteryReceiver() {
            ...
            ParisBlackWallpaperService.this.registerReceiver(mBatteryReceiver, filter);
        }
        ...
        private void unregisterBatteryReceiver() {
            ...
            ParisBlackWallpaperService.this.unregisterReceiver(mBatteryReceiver);
        }
    }
