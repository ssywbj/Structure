...
public abstract class AnimWallpaperService extends CanvasWallpaperService {

    public abstract class AnimEngine extends CanvasEngine {
        ...
        private boolean mIsAppendTime = true, mIsHour24Scale;
    ...
    protected void onTimeChanged() {
        ...
        /**
         * 出场动画完成时的回调。<p>Note：在出场动画播放完后再开启时间的正常刷新工作。
         * <p><em>Note：若在此方法进行了时间刷新、数据监听等注册操作，要记得在表盘不可见状态时进行反注删操作，具体可见其实现类的用法。</em>
         */
