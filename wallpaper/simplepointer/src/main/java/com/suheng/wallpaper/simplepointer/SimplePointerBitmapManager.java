...
public class SimplePointerBitmapManager extends BitmapManager {
    ...
    public int getWeatherResId(int type) {
        switch (type) {
            case 0://晴 Sunny
                return R.drawable.weather_day_qing;
            case 1://多云 Cloudy
                return R.drawable.weather_day_duoyun;
            case 2://阴	Overcast
                return R.drawable.weather_yintian;
            case 3://阵雨 Shower
            case 301://降雨 Rain
                return R.drawable.weather_chenyu;
            ...
            case 302://降雪 Snow
                return R.drawable.weather_chenxue;
            ...
            case 31://强沙尘暴 Sandstorm
                return R.drawable.weather_qiangshachenbao;
            case 32://浓雾 Dense foggy
            case 57://大雾 Heavy foggy
                return R.drawable.weather_nongwu;
            case 33://雪 Snow
                return R.drawable.weather_xue;
            case 49://强浓雾	Moderate foggy
            case 58://特强浓雾 Severe foggy
                return R.drawable.weather_qiangnongwu;
            case 53://霾 Haze
                return R.drawable.weather_mai;
            case 54://中度霾	Moderate haze
                return R.drawable.weather_zhongmai;
            case 55://重度霾	Heavy haze
                return R.drawable.weather_damai;
            case 56://严重霾	Severe haze
                return R.drawable.weather_yanzhongmai;
            default:
                return R.drawable.weather_no_data;
        }
    }
    ...
    public int getOverseasWeatherResId(int type) {
        switch (type) {
            ...
            case 22://Snow 雪
                return R.drawable.weather_xue;
            case 24://Ice 冻雪
                return R.drawable.weather_shuangdong;
            case 25://Sleet 冰霰
            ...
            case 42://Mostly Cloudy w/ T-Storms 大部分多云，有时有雷雨
                return R.drawable.weather_duoyunleiyu;
            default:
                return R.drawable.weather_no_data;
        }
    }
