...
public final class UiDataModel {
     ...
     */
    public enum Tab {
        STOPWATCH(Screensaver.class, R.drawable.paint_number_ic_0, R.string.app_name);
    ...
    *//**
     * Updates the scrolling state in the {@link com.android.deskclock.uidata.UiDataModel} for this tab.
     *
