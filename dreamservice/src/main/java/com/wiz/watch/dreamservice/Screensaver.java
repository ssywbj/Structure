...
//                    Utils.refreshAlarm(com.android.deskclock.Screensaver.this, mContentView);
//                }
//            };
//
...
//        @Override
//        public void run() {
//        LOGGER.v("mMidnightUpdater run() updateDate ");
...
//        //test by zenggz start
//        LOGGER.v("zenggz  setClockStyle dimNightMode = " + dimNightMode);
...
//        LOGGER.v("zenggz  onDreamingStarted +++++ ");
//        super.onDreamingStarted();
//	//setDozeScreenState(4);//Display.STATE_DOZE_SUSPEND
//        //startDozing();
//
//        try {
//            Class c = Class.forName("android.service.dreams.DreamService");
//            Method m = c.getMethod("setDozeScreenState",int.class);
//            m.invoke(com.android.deskclock.Screensaver.this,4);
//
//            m = c.getMethod("startDozing");
//            m.invoke(com.android.deskclock.Screensaver.this);
//        } catch (Exception e) {
...
//        LOGGER.v("zenggz  onDreamingStopped ");
//    }
//
//    @Override
//    protected void dumpOnHandler(FileDescriptor fd, PrintWriter pw, String[] args) {
//        LOGGER.v("zenggz  dumpOnHandler ");
//    }
//
//    @Override
//    public void requestWakeUp() {
//        LOGGER.v("zenggz  requestWakeUp ");
//    }
//
//    @Override
//    public void onRequestShowDoze() {
//        LOGGER.v("zenggz  onRequestShowDoze ");
//    }
//
//    @Override
//    public void onRequestHideDoze() {
//        LOGGER.v("zenggz  onRequestHideDoze ");
//    }
//*/
////test by zenggz end
//
