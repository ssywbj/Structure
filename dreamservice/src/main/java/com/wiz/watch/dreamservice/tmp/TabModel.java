...
final class TabModel {
     ...
     */
    UiDataModel.Tab getTab(int ordinal) {
     ...
     * @return the tab at the given {@code ordinal}
     */
    UiDataModel.Tab getTabAt(int position) {
        final int ordinal;
    ...
    void setSelectedTab(UiDataModel.Tab tab) {
        final UiDataModel.Tab oldSelectedTab = getSelectedTab();
    ...
    *//**
     ...
     */
    /*void setTabScrolledToTop(UiDataModel.Tab tab, boolean scrolledToTop) {
