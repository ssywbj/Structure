...
import com.wiz.watch.faceclassic.view.WizScaleScrollbar;
...
public class FaceConfigFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return LayoutInflater.from(getContext()).inflate(R.layout.fragment_watch_face_config, container, false);
    }
    ...
    private final class AppListAdapter extends RecyclerAdapter<AppInfo> {
        ...
        protected void bindView(RecyclerView.ViewHolder viewHolder, final int position, final AppInfo data) {
            if (viewHolder instanceof ContentHolder) {
                ...
                contentHolder.appName.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        contentHolder.imageIcon.performClick();
                    }
                });
                contentHolder.imageIcon.setOnClickListener(new View.OnClickListener() {
                    @Override
