package com.wiz.watchface.joker;
...
public class WizLunar {
    ...
    private static final String[] MONTH_NUMBER_ARRAY = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊"};
    ...
    private static final byte[] SSolarArray = {
            //1970
            ...
            6, 20, 4, 19, 6, 21, 5, 21, 6, 21, 6, 22, 8, 23, 8, 24, 8, 23, 9, 24, 8, 23, 8, 22,
            //1980
            ...
            5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22,
            6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 9, 24, 8, 23, 7, 22,
            6, 20, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 22, 8, 23, 7, 22, 7, 21,
    ...
    private static final GregorianCalendar sUtcCal;
    ...
    private static boolean isMonthDayOverFlow(int year, int month, int monthDay, int leapMonth, boolean isLeapMonth) {
        int temp = ((month > leapMonth) && leapMonth != 0) || (month == leapMonth && isLeapMonth) ? month + 1 : month;
     ...
     */
    public static int[] solarToLunar(long millis) {
    ...
    public static int[] solarToLunar(Date date) {
     ...
     */
    private static String getLunarDateString(int lunarYear, int lunarMonth, int lunarDay, boolean isLeapMonth, int showFlag) {
