...
public class WizButton extends AppCompatButton {
    ...
    public WizButton(Context context) {
        this(context, null);
    }

    public WizButton(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.buttonStyle);
    }

    public WizButton(Context context, AttributeSet attrs, int defStyleAttr) {
