...
public class KcalView extends WatchFaceView {
    ...
    public KcalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    private void init() {
        mBitmapIcon = BitmapHelper.get(getContext(), R.drawable.icon_kcal, Float.parseFloat(mContext.getString(R.string.ratio)));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final String text = String.valueOf(mSportDataManager.getCalories());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = String.valueOf(mSportDataManager.getCalories());
        mPaint.getTextBounds(text, 0, text.length(), mRect);
