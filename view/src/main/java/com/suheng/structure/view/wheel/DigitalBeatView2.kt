...
class DigitalBeatView2 @JvmOverloads constructor(
    ...
    private val mRunnable: Runnable = object : Runnable {
        override fun run() {
            ...
            this@DigitalBeatView2.currentSecond = currentSecond
            startSecondAnim()
    ...
    private fun drawSeconds(canvas: Canvas) {
        canvas.save {
            ...
            //var outsideOffsetX = 0f //减掉屏幕外数字的宽度，让数字从屏幕外开始绘制
            ...
            Log.w(TAG, "drawSeconds: $sb, startSecond: $startSecond,endSecond: $endSecond")
        }
    }
