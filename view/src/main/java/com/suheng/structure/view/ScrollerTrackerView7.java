...
public class ScrollerTrackerView7 extends View {
    private static final String TAG = ScrollerTrackerView7.class.getSimpleName();
    private int mIndex;
    ...
    public ScrollerTrackerView7(Context context) {
        super(context);
        this.init();
    }

    public ScrollerTrackerView7(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public ScrollerTrackerView7(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
